...
DATAOUTPUT=$SCRATCH/gambic/03_trimmed/00_fastqc_raw
SCRIPT=$DATADIRECTORY/00_scripts/fastqc_trimmed_scripts
HEADER=$DATADIRECTORY/00_scripts/header.txt
FASTQCENV="path_to_bin"
...
do
        ...
        echo "cd $SCRATCH/gambic/03_trimmed" >> $SCRIPT/fastqc_${FILE##*/}.sh ; # append the echoed line in the script file (we go to the data folder of our project)
